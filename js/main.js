...
/*************************************************************************************
------------ ANSWER -------------------
console.log(y) would read undefined because it is local to the scopeThis() function. console.log(x) would read "I'm a local variable" because this function can reach out and still refer to the variable previously mentioned in the outer function. The y would not be able to reach in and refer to a variable mentioned on the inside of another function.
**************************************************************************************/
...
/*************************************************************************************
------------ ANSWER -------------------
console.log(x) would read undefined because the variable is not defined before the console.log(). console.log(foo) would return "function hoisting" because the function would be hoisted.
**************************************************************************************/
...
/**************************************************************************************
------------ ANSWER -------------------
Inside the IFEE add would be 4 and outside the function add would be undefined. 
**************************************************************************************/
